 ...
 */
class Workload(loadavg:Double,lifeSpan:Int,taskDur:Int,taskCount:Int) extends Runnable{
  ...
  override def run(): Unit = {
    ...
    do {
      ...
      this.lambda = (loadavg*191.7*80/taskDur)
    ...
    //val hoprecord = ExperimentFunctions.getHopsCDF(jobList)
    ...
    //ExperimentFunctions.printMaxMinAvgHops(jobList)
    sys.exit()
  }
